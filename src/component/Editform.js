        ...
        e.preventDefault();
            ...
            try {
              if (name == '' || lastname == '' || mobile == '' || email=='' || Project =='') {
                ...
                const response = await fetch(`http://localhost:5000/0auth/update/${id}`, {
                    method: 'POST',
                    headers: {
                      'Content-Type': 'application/json',
                    },
                    body: JSON.stringify({name:name, lastname:lastname , email:email, project:Project ,mobile:mobile, id:id }),
                    credentials: 'include',
                  });
